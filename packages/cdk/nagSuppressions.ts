...
export const nagSuppressions = (stack: Stack, account: string) => {
  ...
  safeAddNagSuppression(
    stack,
    `/EpsAssistMeStack/VectorIndex/IndexReadyWait/${stack.stackName}-index-ready-waitDelayFunction/Resource`,
    [
      {
        id: "AwsSolutions-L1",
  ...
  safeAddNagSuppression(
    stack,
    `/EpsAssistMeStack/VectorIndex/PolicySyncWait/${stack.stackName}-policy-sync-waitDelayFunction/Resource`,
    [
      {
        id: "AwsSolutions-L1",
        reason: "DelayResource uses Python 3.12 which is the latest stable runtime available for the delay functionality."
  ...
  safeAddNagSuppression(
    stack,
    `/EpsAssistMeStack/VectorIndex/PolicySyncWait/${stack.stackName}-policy-sync-waitDelayProvider/framework-onEvent/Resource`,
    [
      {
        id: "AwsSolutions-L1",
  ...
  safeAddNagSuppression(
    stack,
    `/EpsAssistMeStack/VectorIndex/IndexReadyWait/${stack.stackName}-index-ready-waitDelayProvider/framework-onEvent/Resource`,
    [
      {
        id: "AwsSolutions-L1",
        reason: "OnEvent uses Node22.x which is the latest stable runtime available for the onEvent functionality."
